...
export const EDITORIAL_NOTE_BLOCK = {
  ...
  examples: [
    'Accueil — « À qui cela s’adresse »',
    'Exemples travaillés — étiquette « Exemple » (mise en place) ou « Dans l’exemple » (imbriqué sous une étape) ; toujours une EditorialNote grise, jamais un GuideCallout',
...
export const CALLOUT_BLOCK = {
  ...
  examples: ['Accueil — « Vous ne savez pas dans quelle phase vous êtes ? »', "Procurement — Scope", "Data stewardship — retention question"],
} as const;
