...
// Lives here, not in CreateDiscoveryPage.tsx, because the French build swaps module
// sources under src/lib only. While this array sat in the component it could never be
// swapped, so the French page rendered these source descriptions in English.
