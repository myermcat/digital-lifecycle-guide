...
export type PrivacyLinkedProse = {
  text: string;
  externalLinks?: ExternalPhraseLink[];
  internalLinks?: InternalPhraseLink[];
};

export type PrivacyCloserLookBlock = PrivacyLinkedProse & {
  title: string;
};

export type PrivacyPhasePreviewBlock = {
  title: string;
  preview: string;
  popup: PrivacyLinkedProse;
};
...
export const PRIVACY_THREAD = {
  ...
  lead: {
    text:
      "Privacy runs through the whole life of a service that handles people's personal information, from the first design sketch to the day the data is destroyed. Personal information is anything that can identify a person: a name, a case number, an address, an IP address. Canada's Privacy Act sets the rules for how a federal institution may collect, use, and share it. The business owner of the application does not run the privacy reviews or write the legal text. Their part is the privacy decisions: what personal information the service collects, making sure it is assessed before launch, and answering for how it is protected.",
    ...
    blocks: [
      {
        ...
        text:
          "A Privacy Impact Assessment, or PIA, is the formal check of what could go wrong with the personal information a service handles, done before it launches. It records what is collected and why, the legal authority for collecting it, how the data flows, how it is protected, and how long it is kept, then names the risks and how they will be reduced. It is triggered whenever a service uses personal information to make a decision about someone, or changes that use: when a paper benefits form moves online, for example, the PIA is updated before the new service goes live. Under the Directive on Privacy Practices a PIA is required, and the Digital Privacy Playbook walks through it step by step. The Office of the Privacy Commissioner reviews a PIA and advises, but does not approve it; the sign-off stays with the institution, with the business owner.",
        externalLinks: [
          { phrase: "Directive on Privacy Practices", linkKey: "directive-privacy-practices" },
      ...
      },
      {
        ...
        text:
          "People have a right to know what a service collects and why, before they hand it over. That is the job of the privacy notice, in plain words and in the right place. A complete notice says seven things: why the information is collected, the legal authority for collecting it, whether it will be shared, what happens to someone who does not provide it, their right to see and correct it, the Personal Information Bank it is held in, and how to complain to the Office of the Privacy Commissioner. It is easy to forget, and it is the part the public actually sees.",
        externalLinks: [
          { phrase: "privacy notice", linkKey: "digital-privacy-playbook-privacy-notices" },
        ] satisfies ExternalPhraseLink[],
      },
  ...
  byPhase: {
    ...
    blocks: [
      ...
      },
      {
        ...
        popup: {
          text:
            "Once the service is running, the privacy work continues. The privacy notice is published before any collection begins and kept accurate, the Privacy Impact Assessment is updated whenever the service starts collecting or using personal information in a new way, and access to the data is limited and logged. If a privacy breach happens, there is a plan to contain it, assess the harm, notify the people affected, and report it; the Office of the Privacy Commissioner is who a federal institution works with, and it provides a breach-reporting form. For the security side of protecting the data, see the security thread.",
          externalLinks: [
            { phrase: "Office of the Privacy Commissioner", linkKey: "opc-federal-institutions" },
          ] satisfies ExternalPhraseLink[],
          internalLinks: [{ phrase: "the security thread", to: THREADS.security.path }] satisfies InternalPhraseLink[],
        },
      },
      {
        title: "Sunset.",
        preview: "Dispose of personal information the right way.",
        popup: {
          text:
            "When a service retires, the personal information does not just disappear. It is kept or destroyed under its retention schedule, transferred or archived where required, and securely disposed of so it cannot be recovered. How long to keep what is a records question, handled in data stewardship, and destroying it safely is a security one, handled in the security thread. A service that keeps personal information past its retention is a standing privacy risk.",
          internalLinks: [
            { phrase: "data stewardship", to: THREADS["data-stewardship"].path },
            { phrase: "the security thread", to: THREADS.security.path },
  ...
  furtherReading: {
    text:
      "This thread comes under the Privacy Act, with the Treasury Board Directive on Privacy Practices setting the day-to-day obligations, including the Privacy Impact Assessment. The Digital Privacy Playbook is the closest companion, turning the rules into steps. It also draws on the made-in-Canada seven principles of privacy by design, and, for how other jurisdictions handle the same assessment, the UK ICO's guidance on data protection impact assessments and Article 25 of the GDPR.",
    externalLinks: [
      { phrase: "Privacy Act", linkKey: "privacy-act" },
      { phrase: "Directive on Privacy Practices", linkKey: "directive-privacy-practices" },
      { phrase: "Digital Privacy Playbook", linkKey: "digital-privacy-playbook" },
