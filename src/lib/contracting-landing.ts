...
export const CONTRACTING_LANDING = {
  ...
  businessOwnerNote:
    "Under Treasury Board's Directive on the Management of Procurement, your department is the “business owner.” A procurement specialist, the “contracting authority,” runs the buying. You own the result. That split is worth keeping in mind on every page here.",
  whyItMatters:
  ...
  whoseJob:
    "Your department's. You can give the building to a supplier, but the responsibility stays with you. If the service lets a user down, “the contractor did it” is not an answer anyone will accept. The Directive says the same thing in plainer policy terms: the business owner is accountable for the outcomes, start to finish.",
  byRegionIntro:
  ...
  sources: [
    {
      ...
      description: "Treasury Board Directive on the Management of Procurement",
      href: "https://www.tbs-sct.canada.ca/pol/doc-eng.aspx?id=32692",
    },
    {
...
export const PROCUREMENT_HELD_OPEN = {
  paragraphs: [
    "Procurement is the process of buying: the competitions, the approvals, the paperwork that gets you to a signed contract.",
