...
export function DependenciesAndStandardsThreadPage() {
  const {
    title,
    lead,
    whatGoodLooksLike,
  ...
  return (
    <GuideLayout id={`thread-${DEPENDENCIES_AND_STANDARDS_THREAD.slug}`}>
      ...
      <ThreadCoreStrip content={DEPENDENCIES_AND_STANDARDS_CORE_STRIP} />
